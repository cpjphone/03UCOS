...
#define key1  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1)		  //前左
#define key2  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_2)		  //前右
...
#define LED_LED1_ON()   GPIO_SetBits(GPIOA, GPIO_Pin_6 );  	       //LED1  亮
#define LED_LED1_OFF()  GPIO_ResetBits(GPIOA, GPIO_Pin_6 ); 	   //LED1  灭

#define LED_LED2_ON()   GPIO_SetBits(GPIOA, GPIO_Pin_7 );  	       //LED1  亮
#define LED_LED2_OFF()  GPIO_ResetBits(GPIOA, GPIO_Pin_7 ); 	   //LED1  灭
