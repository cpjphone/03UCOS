	...
	while (1)
 	{
		...
		if((!key1)&(!key2)&(!key3)&(!key4)&(key_front)&(key_back)&(key_left1)&(key_right1)&(key_left2)&(key_right2)&(key_FL)&(key_FR)&(key_BL)&(key_BR))
 		car_freedom(40,20); 
