...
PROGBAR_Handle PROGBAR_CreateAsChild (int x0, int y0, int xsize, int ysize, WM_HWIN hParent, int Id, int Flags);//PROGBAR进度条，用于观察。
...
void            PROGBAR_SetMinMax   (PROGBAR_Handle hObj, int Min, int Max);	  //设置进度条的最小和最大数值。
