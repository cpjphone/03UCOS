...
void GUIDEMO_Cursor(void) {
  ...
  GUI_CURSOR_SetPosition(0,0);		  	//设置光标位置
  GUI_CURSOR_Select(&GUI_CursorArrowM);   //gui光标选择
}
